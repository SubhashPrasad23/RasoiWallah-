...
function RestaurantCard({ res }) {
  ...
  return (
    <div className="max-w-2xl mx-auto  ">
      <div className="bg-white hover:bg-gray-300 hover:scale-105 w-[280px] h-[440px]  shadow-lg shadow-gray-400  rounded-lg max-w-sm ">
        <img
        ...
        <div className="px-5 py-2 ">
          ...
          <h4 className="text-black mt-1">{cuisines.join(", ")}</h4>
